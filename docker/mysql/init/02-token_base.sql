...
-- ----------------------------
-- Table structure for tb_flash_voucher
-- ----------------------------
DROP TABLE IF EXISTS `tb_flash_voucher`;
CREATE TABLE `tb_flash_voucher`  (
  `voucher_id` bigint(20) UNSIGNED NOT NULL COMMENT '关联的优惠券的id',
  `stock` int(8) NOT NULL COMMENT '库存',
  `limit_count` int(8) NOT NULL DEFAULT 1 COMMENT '每人限购数量：1=限购券（一人一单）；>1=限购券（同一用户最多购买N张）',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '限购优惠券表，与优惠券是一对一关系' ROW_FORMAT = Compact;

-- 已存在旧表时执行：ALTER TABLE `tb_flash_voucher` ADD COLUMN `limit_count` int(8) NOT NULL DEFAULT 1 COMMENT '每人限购数量：1=限购券；>1=限购券' AFTER `stock`;

-- ----------------------------
-- Records of tb_flash_voucher
-- ----------------------------
...
CREATE TABLE `tb_voucher`  (
  ...
  `type` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0,普通券；1,限购券',
